...
First, install the backend dependancies:
...
To troubleshoot this, install nodeJS (https://nodejs.org/en/download/) and verify your npm and node versions, then attempt "npm install" again.
